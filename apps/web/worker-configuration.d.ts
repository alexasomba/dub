/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 93f1a8c8d6f574321b8b8ae2c9e749e9)
// Runtime types generated with workerd@1.20260107.1 2025-11-06 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		STRIPE_APP_WEBHOOK_SECRET: string;
		...
		BITLY_CLIENT_ID: string;
		BITLY_CLIENT_SECRET: string;
		UNSPLASH_ACCESS_KEY: string;
		STORAGE_ACCESS_KEY_ID: string;
		STORAGE_SECRET_ACCESS_KEY: string;
		STORAGE_ENDPOINT: string;
		STORAGE_BASE_URL: string;
		DUB_SLACK_HOOK_CRON: string;
		DUB_SLACK_HOOK_LINKS: string;
		NEXT_PUBLIC_NGROK_URL: string;
		ANTHROPIC_API_KEY: string;
		NEXT_PUBLIC_IS_DUB: string;
		CRON_SECRET: string;
		...
		STRIPE_APP_SECRET_KEY: string;
		FIRECRAWL_API_KEY: string;
		SINGULAR_WEBHOOK_TOKEN: string;
		HUBSPOT_CLIENT_ID: string;
		HUBSPOT_CLIENT_SECRET: string;
		RATE_LIMITER: DurableObjectNamespace /* RateLimitDO */;
		CLICK_CACHE: DurableObjectNamespace /* ClickCacheDO */;
		DB: D1Database;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "OPERATOR_TOKEN" | "NEXT_PUBLIC_APP_NAME" | "NEXT_PUBLIC_APP_DOMAIN" | "NEXT_PUBLIC_APP_SHORT_DOMAIN" | "TINYBIRD_API_KEY" | "TINYBIRD_API_URL" | "PROJECT_ID_VERCEL" | "TEAM_ID_VERCEL" | "AUTH_BEARER_TOKEN" | "UPSTASH_REDIS_REST_URL" | "UPSTASH_REDIS_REST_TOKEN" | "QSTASH_TOKEN" | "QSTASH_CURRENT_SIGNING_KEY" | "QSTASH_NEXT_SIGNING_KEY" | "DATABASE_URL" | "PLANETSCALE_DATABASE_URL" | "NEXTAUTH_SECRET" | "NEXTAUTH_URL" | "RESEND_API_KEY" | "SMTP_HOST" | "SMTP_PORT" | "SMTP_USER" | "SMTP_PASSWORD" | "NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET" | "STRIPE_APP_WEBHOOK_SECRET" | "SHOPIFY_WEBHOOK_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "EDGE_CONFIG" | "EDGE_CONFIG_ID" | "BITLY_CLIENT_ID" | "BITLY_CLIENT_SECRET" | "UNSPLASH_ACCESS_KEY" | "STORAGE_ACCESS_KEY_ID" | "STORAGE_SECRET_ACCESS_KEY" | "STORAGE_ENDPOINT" | "STORAGE_BASE_URL" | "DUB_SLACK_HOOK_CRON" | "DUB_SLACK_HOOK_LINKS" | "NEXT_PUBLIC_NGROK_URL" | "ANTHROPIC_API_KEY" | "NEXT_PUBLIC_IS_DUB" | "CRON_SECRET" | "SLACK_CLIENT_ID" | "SLACK_CLIENT_SECRET" | "SLACK_SIGNING_SECRET" | "DYNADOT_API_KEY" | "DYNADOT_BASE_URL" | "YOUTUBE_CLIENT_ID" | "YOUTUBE_CLIENT_SECRET" | "X_CLIENT_ID" | "X_CLIENT_SECRET" | "TIKTOK_CLIENT_ID" | "TIKTOK_CLIENT_SECRET" | "PAYPAL_CLIENT_ID" | "PAYPAL_CLIENT_SECRET" | "PAYPAL_WEBHOOK_ID" | "STRIPE_APP_SECRET_KEY_TEST" | "STRIPE_APP_SECRET_KEY" | "FIRECRAWL_API_KEY" | "SINGULAR_WEBHOOK_TOKEN" | "HUBSPOT_CLIENT_ID" | "HUBSPOT_CLIENT_SECRET">> {}
}
